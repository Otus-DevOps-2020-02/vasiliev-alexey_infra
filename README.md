...
2. Создана локальная инфраструктура с помощью Vagrant  и на ней   с помощью провиженера Ansible прокачены playbook
3. Устновлена Molecule  (для выполнения заданич пришлось изменить версии библиотек, так как в 3.0 убрана поддержка vagrant)
4. Протестирована конфигурация роли Db

ДЗ*
Конфигурация дополнена для конфигурацией nginx через ansible.extra_vars 
...
ДЗ*
Изучен плагин для  генерации  inventory  gcp
___
